...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for competitive matches and improve teamwork skills",
    ...
    "Drama Club": {
        "description": "Cast, rehearse, and perform plays and improv scenes",
    ...
    "Science Olympiad": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["abella@mergington.edu", "benjamin@mergington.edu"]
    },
    "Debate Team": {
